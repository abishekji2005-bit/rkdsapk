...
const AppointmentEditorPanel = lazy(() => import("modules/appointments/components/appointment-editor").then(m => ({ default: m.AppointmentEditorPanel })));
const AgeBarChart = lazy(() => import("./chart.age").then(m => ({ default: m.AgeBarChart })));
const AppointmentsByDateChart = lazy(() => import("./chart.appointments-date").then(m => ({ default: m.AppointmentsByDateChart })));
const FinancesByDateChart = lazy(() => import("./chart.finance").then(m => ({ default: m.FinancesByDateChart })));
const GenderPieChart = lazy(() => import("./chart.gender").then(m => ({ default: m.GenderPieChart })));
const MostAppliedTreatmentsChart = lazy(() => import("./chart.most-applied-treatments").then(m => ({ default: m.MostAppliedTreatmentsChart })));
const MostInvolvedTeethChart = lazy(() => import("./chart.most-involved-teeth").then(m => ({ default: m.MostInvolvedTeethChart })));
const TreatmentsByGenderChart = lazy(() => import("./chart.treatments-gender").then(m => ({ default: m.TreatmentsByGenderChart })));
const TreatmentsNumberChart = lazy(() => import("./chart.treatments-number").then(m => ({ default: m.TreatmentsNumberChart })));
