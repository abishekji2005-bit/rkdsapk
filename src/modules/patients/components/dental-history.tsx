...
const EditableListComponent = lazy(() => import("common-components/editable-list").then(m => ({ default: m.EditableListComponent })));
const TeethDeciduousChart = lazy(() => import("modules/patients/components/teeth-deciduous").then(m => ({ default: m.TeethDeciduousChart })));
const TeethPermanentChart = lazy(() => import("modules/patients/components/teeth-permanent").then(m => ({ default: m.TeethPermanentChart })));
