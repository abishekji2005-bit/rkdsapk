...
const PatientDetailsPanel = lazy(() => import("modules/patients/components/patient-details").then(m => ({ default: m.PatientDetailsPanel })));
const DentalHistoryPanel = lazy(() => import("modules/patients/components/dental-history").then(m => ({ default: m.DentalHistoryPanel })));
const OrthoCaseSheetPanel = lazy(() => import("modules/orthodontic/components/case-sheet").then(m => ({ default: m.OrthoCaseSheetPanel })));
